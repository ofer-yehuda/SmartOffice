...
class MainActivity : AppCompatActivity() {
    ...
    private val cloudCredentials = EstimoteCloudCredentials("sap-smart-office-n3o", "96265a41aeb641a0a4c1632d1490afb5")
    // ============
...
//                .withTelemetryReporting()
        ...
        val venueZone = proximityObserver.zoneBuilder()
                .forAttachmentKeyAndValue("RAA03", "test")
                .inCustomRange(5.0)
        ...
        val mintDeskZone = proximityObserver.zoneBuilder()
                .forAttachmentKeyAndValue("RAA03", "itsupport")
                .inNearRange()
        ...
        val blueberryDeskZone = proximityObserver.zoneBuilder()
                .forAttachmentKeyAndValue("RAA03", "dshop")
                .inNearRange()
